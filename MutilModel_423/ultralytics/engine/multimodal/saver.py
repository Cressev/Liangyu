...
class MultiModalSaver:
    ...
    def save(
        ...
        has_real_rgb = result.orig_imgs.get('rgb', None) is not None
        has_real_x = result.orig_imgs.get('x', None) is not None
        ...
        if self.save_img:
            ...
            # 1.3 双模态并排合并图
            if has_real_rgb and has_real_x:
