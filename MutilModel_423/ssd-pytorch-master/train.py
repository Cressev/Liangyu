...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    classes_path    = os.environ.get("SSD_CLASSES_PATH", 'model_data/voc_classes.txt')
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = os.environ.get("SSD_MODEL_PATH", '')
    #------------------------------------------------------#
    ...
    #                       (当Freeze_Train=False时失效)
    #------------------------------------------------------------------#
    Init_Epoch          = int(os.environ.get("SSD_INIT_EPOCH", "0"))
    Freeze_Epoch        = int(os.environ.get("SSD_FREEZE_EPOCH", "0"))
    Freeze_batch_size   = int(os.environ.get("SSD_FREEZE_BATCH", "16"))
    #------------------------------------------------------------------#
    #   解冻阶段训练参数
    ...
    #------------------------------------------------------------------#
    UnFreeze_Epoch      = int(os.environ.get("SSD_EPOCHS", "350"))
    Unfreeze_batch_size = int(os.environ.get("SSD_BATCH", "64"))
    #------------------------------------------------------------------#
    #   Freeze_Train    是否进行冻结训练
    #                   默认先冻结主干训练后解冻训练。
    #                   如果设置Freeze_Train=False，建议使用优化器为sgd
    #------------------------------------------------------------------#
    Freeze_Train        = os.environ.get("SSD_FREEZE_TRAIN", "False").lower() in {"1", "true", "yes", "y"}
    ...
    #------------------------------------------------------------------#
    save_period         = int(os.environ.get("SSD_SAVE_PERIOD", "10"))
    #------------------------------------------------------------------#
    #   save_dir        权值与日志文件保存的文件夹
    #------------------------------------------------------------------#
    save_dir            = os.environ.get("SSD_SAVE_DIR", 'logs')
    #------------------------------------------------------------------#
    ...
    #------------------------------------------------------------------#
    eval_flag           = True
    eval_period         = int(os.environ.get("SSD_EVAL_PERIOD", "10"))
    #------------------------------------------------------------------#
    ...
    #------------------------------------------------------------------#
    num_workers         = int(os.environ.get("SSD_WORKERS", "4"))

    #------------------------------------------------------#
    #   train_annotation_path   训练图片路径和标签
    #   val_annotation_path     验证图片路径和标签
    #------------------------------------------------------#
    train_annotation_path   = os.environ.get("SSD_TRAIN_TXT", '2007_train.txt')
    val_annotation_path     = os.environ.get("SSD_VAL_TXT", '2007_val.txt')
